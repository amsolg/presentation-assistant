...
Test d'ajout de slide 22 (statistiques ligne bleue Premier Tech)
Test des statistiques : 87% Satisfaction Client vs 23+ Années d'Expérience

Ce test verifie la capacite du script 05 a ajouter une slide de statistiques
avec ligne bleue dans une presentation existante en utilisant le template slide 22.
Il teste le bon positionnement : Satisfaction Client (droite), Expérience (gauche).

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter les statistiques ligne bleue avec le script 05 (slide 22)
3. Verifier le resultat et le positionnement correct
"""
...
class TestSlide22BlueLine:
    """
    Classe de test pour verifier l'ajout de slide 22 avec le script 05.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 05 - Satisfaction vs Experience"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_title = "TEST UNITAIRE - Script 05"
            base_subtitle = "Presentation de base pour test statistiques"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Statistiques Satisfaction vs Experience"
            base_project = "test_script_05_satisfaction_vs_experience"
    ...
    def add_statistics_slide(self, base_presentation_path):
        """
        Ajoute une slide de statistiques ligne bleue avec le script 05.
        ...
        """
        try:
            print(f"STATISTIQUES Etape 2: Ajout des statistiques ligne bleue...")

            # Parametres pour les statistiques
            stat1_value = "87%"
            stat1_label = "Satisfaction Client"
            stat2_value = "23+"
            stat2_label = "Années d'Experience"
            slide_title = "Performance et Expérience"
            ...
            print(f"EXEC Ajout de statistiques ligne bleue:")
            print(f"   {' '.join(cmd_05)}")
            ...
            print(f"SUCCES Statistiques ligne bleue ajoutees avec succes!")
            ...
            print(f"   INFO Style: blue_line (slide 22)")
            print(f"   INFO Configuration: 87% Satisfaction Client (droite), 23+ Années d'Experience (gauche)")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 05 slide 22.
...
def main():
    ...
    test_runner = TestSlide22BlueLine()
