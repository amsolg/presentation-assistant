...
Test d'ajout de slide 25 (4 statistiques & Mots-clés Premier Tech)

Ce test verifie la capacite du script 05 a ajouter une slide de 4 statistiques
avec mots-cles dans une presentation existante en utilisant le template slide 25.

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter les 4 statistiques avec le script 05
...
class TestSlide25FourStats:
    """
    Classe de test pour verifier l'ajout de slide 25 (four_stats) avec le script 05.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 05 - Slide 25 Four Stats"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_title = "TEST UNITAIRE - Script 05 Four Stats"
            base_subtitle = "Presentation de base pour test 4 statistiques"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test 4 Statistiques"
            base_project = "test_script_05_slide_25_four"
    ...
    def add_statistics_slide(self, base_presentation_path):
        """
        Ajoute une slide de 4 statistiques avec le script 05.
        ...
        """
        try:
            print(f"STATISTIQUES Etape 2: Ajout des 4 statistiques...")

            # Parametres pour les statistiques (4 statistiques requises)
            stat1_value = "98%"
            stat1_label = "Satisfaction Client"
            stat2_value = "120M€"
            stat2_label = "Chiffre d'Affaires"
            stat3_value = "45+"
            stat3_label = "Pays Actifs"
            stat4_value = "2.5M"
            stat4_label = "Clients Servis"
            slide_title = "Dashboard de Performance"

            # Commande pour ajouter les statistiques (4 statistiques)
            cmd_05 = [
                sys.executable,
            ...
            print(f"EXEC Ajout de 4 statistiques:")
            print(f"   {' '.join(cmd_05)}")
            ...
            print(f"SUCCES 4 statistiques ajoutees avec succes!")
            ...
            print(f"   INFO Style: four_stats (slide 25)")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 05 slide 25 four stats.
...
def main():
    ...
    test_runner = TestSlide25FourStats()
