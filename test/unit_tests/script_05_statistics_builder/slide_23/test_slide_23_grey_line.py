...
Test d'ajout de slide 23 (statistiques ligne grise Premier Tech)

Ce test verifie la capacite du script 05 a ajouter une slide de statistiques
avec ligne grise dans une presentation existante en utilisant le template slide 23.

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter les statistiques ligne grise avec le script 05
...
class TestSlide23GreyLine:
    """
    Classe de test pour verifier l'ajout de slide 23 (grey_line) avec le script 05.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 05 - Slide 23 Grey Line"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_title = "TEST UNITAIRE - Script 05 Grey Line"
            base_subtitle = "Presentation de base pour test statistiques ligne grise"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Statistiques Ligne Grise"
            base_project = "test_script_05_slide_23_grey"
    ...
    def add_statistics_slide(self, base_presentation_path):
        """
        Ajoute une slide de statistiques ligne grise avec le script 05.
        ...
        """
        try:
            print(f"STATISTIQUES Etape 2: Ajout des statistiques ligne grise...")

            # Parametres pour les statistiques
            stat1_value = "92%"
            stat1_label = "Efficacité Operationnelle"
            stat2_value = "156M$"
            stat2_label = "Chiffre d'Affaires"
            slide_title = "Performance Technique"
            ...
            print(f"EXEC Ajout de statistiques ligne grise:")
            print(f"   {' '.join(cmd_05)}")
            ...
            print(f"SUCCES Statistiques ligne grise ajoutees avec succes!")
            ...
            print(f"   INFO Style: grey_line (slide 23)")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 05 slide 23 grey line.
...
def main():
    ...
    test_runner = TestSlide23GreyLine()
