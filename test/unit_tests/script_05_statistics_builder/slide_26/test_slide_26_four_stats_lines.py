...
Test d'ajout de slide 26 (4 statistiques & Mots-clés avec lignes Premier Tech)

Ce test verifie la capacite du script 05 a ajouter une slide de 4 statistiques
avec mots-cles et lignes dans une presentation existante en utilisant le template slide 26.

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter les 4 statistiques avec lignes avec le script 05
...
class TestSlide26FourStatsLines:
    """
    Classe de test pour verifier l'ajout de slide 26 (four_stats_lines) avec le script 05.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 05 - Slide 26 Four Stats Lines"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_title = "TEST UNITAIRE - Script 05 Four Stats Lines"
            base_subtitle = "Presentation de base pour test 4 statistiques avec lignes"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test 4 Statistiques Premium"
            base_project = "test_script_05_slide_26_lines"
    ...
    def add_statistics_slide(self, base_presentation_path):
        """
        Ajoute une slide de 4 statistiques avec lignes avec le script 05.
        ...
        """
        try:
            print(f"STATISTIQUES Etape 2: Ajout des 4 statistiques avec lignes...")

            # Parametres pour les statistiques (4 statistiques premium)
            stat1_value = "99.5%"
            stat1_label = "Uptime Systeme"
            stat2_value = "250M€"
            stat2_label = "Revenue Global"
            stat3_value = "75+"
            stat3_label = "Pays Couverts"
            stat4_value = "5.2M"
            stat4_label = "Utilisateurs Actifs"
            slide_title = "Dashboard Executive - Performance Globale"

            # Commande pour ajouter les statistiques (4 statistiques avec lignes)
            cmd_05 = [
                sys.executable,
            ...
            print(f"EXEC Ajout de 4 statistiques avec lignes:")
            print(f"   {' '.join(cmd_05)}")
            ...
            print(f"SUCCES 4 statistiques avec lignes ajoutees avec succes!")
            ...
            print(f"   INFO Statistique 4: {stat4_value} - {stat4_label}")
            print(f"   INFO Titre: {slide_title}")
            print(f"   INFO Style: four_stats_lines (slide 26) - Version premium avec lignes")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 05 slide 26 four stats lines.
...
def main():
    ...
    test_runner = TestSlide26FourStatsLines()
