...
Test d'ajout de slide 56 (conclusion We are PT Premier Tech)
Test de la conclusion identité collective avec style we_are_pt

Ce test verifie la capacite du script 10 a ajouter une slide de conclusion
We are PT dans une presentation existante en utilisant le template slide 56.
Il teste l'appartenance à Premier Tech et l'identité collective.

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter la conclusion We are PT avec le script 10 (slide 56)
3. Verifier le resultat et l'identité collective
"""
...
class TestSlide56WeArePT:
    """
    Classe de test pour verifier l'ajout de slide 56 avec le script 10.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 10 - We are PT"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_subtitle = "Presentation de base pour test conclusion We are PT"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Conclusion We are PT"
            base_project = "test_script_10_we_are_pt"
    ...
    def add_conclusion_slide(self, base_presentation_path):
        """
        Ajoute une slide de conclusion We are PT avec le script 10.
        ...
        """
        try:
            print(f"CONCLUSION Etape 2: Ajout de la conclusion We are PT...")

            # Parametres pour la conclusion We are PT
            conclusion_message = "Unis par la passion, forts de notre expertise"

            # Commande pour ajouter la conclusion (We are PT n'a pas besoin de beaucoup de parametres)
            cmd_10 = [
                sys.executable,
            ...
            print(f"EXEC Ajout de conclusion We are PT:")
            print(f"   {' '.join(cmd_10)}")
            ...
            print(f"SUCCES Conclusion We are PT ajoutee avec succes!")
            ...
            print(f"   STYLE Style: we_are_pt (slide 56)")
            print(f"   TYPE Type: collective_identity - Identité collective")
            print(f"   AUDIENCE Audience: Toutes audiences")
            print(f"   FOCUS Focus: Appartenance à Premier Tech")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 10 slide 56.
        ...
        try:
            ...
            print(f"TYPE Test: Slide 56 - We are PT (we_are_pt)")
            print(f"TEMPLATE Template: collective_identity pour toutes audiences")
            print(f"FOCUS Focus: Identité collective et appartenance à Premier Tech")
            print(f"{'='*70}")
...
def main():
    ...
    test_runner = TestSlide56WeArePT()
