...
Test d'ajout de slide 31 (4 boîtes grises avec sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 4 boîtes grises
avec sous-titres dans une présentation existante en utilisant le template slide 31.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 31)
...
class TestSlide31GreyDetailed:
    """
    Classe de test pour vérifier l'ajout de slide 31 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 31"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_31"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 4 boîtes grises avec sous-titres
            concept1 = "La collecte des exigences implique une analyse approfondie des besoins fonctionnels et non-fonctionnels avec les parties prenantes."
            concept2 = "La conception architecturale établit les bases techniques solides en définissant les patterns, technologies et interfaces du système."
            concept3 = "Le développement suit les meilleures pratiques de codage avec une approche agile permettant des itérations rapides et efficaces."
            concept4 = "Les tests automatisés et le déploiement continu garantissent la qualité et la fiabilité du produit livré en production."
            subtitle1 = "Analyse des besoins"
            subtitle2 = "Conception technique"
            subtitle3 = "Développement"
            subtitle4 = "Tests et déploiement"
            title = "Cycle de développement logiciel"
            ...
            print(f"   SOUS-TITRES: {subtitle1}, {subtitle2}, {subtitle3}, {subtitle4}")
...
def main():
    ...
    test_runner = TestSlide31GreyDetailed()
