...
Test d'ajout de slide 32 (4 boîtes grises sans sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 4 boîtes grises
sans sous-titres dans une présentation existante en utilisant le template slide 32.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 32)
...
class TestSlide32GreySimple:
    """
    Classe de test pour vérifier l'ajout de slide 32 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 32"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_32"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 4 boîtes grises sans sous-titres
            title = "Architecture complète des outils d'exploitation pour systèmes d'information critiques"
            concept1 = "Monitoring en temps réel avec surveillance proactive des performances système, métriques applicatives et indicateurs de santé infrastructurel pour anticipation des incidents."
            concept2 = "Logging centralisé avec collecte automatisée des événements, indexation intelligente des traces et corrélation avancée pour diagnostic rapide des problématiques."
            concept3 = "Alerting intelligent avec seuils adaptatifs, escalade automatique selon criticité et notifications multi-canaux pour réactivité opérationnelle optimale et continues."
            concept4 = "Backup stratégique avec sauvegarde incrémentale, réplication géographique sécurisée et tests réguliers de récupération pour garantie de continuité d'activité."
...
def main():
    ...
    test_runner = TestSlide32GreySimple()
