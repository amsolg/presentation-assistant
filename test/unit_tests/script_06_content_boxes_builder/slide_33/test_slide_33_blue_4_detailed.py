...
Test d'ajout de slide 33 (4 boîtes bleues avec sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 4 boîtes bleues
avec sous-titres dans une présentation existante en utilisant le template slide 33.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 33)
...
class TestSlide33BlueDetailed:
    """
    Classe de test pour vérifier l'ajout de slide 33 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 33"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_33"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 4 boîtes bleues avec sous-titres
            concept1 = "Nos campagnes marketing ciblées et notre force de vente qualifiée génèrent un pipeline constant de prospects qualifiés et convertissent efficacement."
            concept2 = "Le programme de fidélisation client s'appuie sur un support proactif et des services personnalisés pour maximiser la satisfaction et la rétention."
            concept3 = "L'innovation continue de nos produits répond aux besoins émergents du marché grâce à une recherche et développement centrée sur l'utilisateur."
            concept4 = "L'expansion stratégique vers de nouveaux marchés géographiques et segments clients ouvre des opportunités de croissance significatives."
            subtitle1 = "Acquisition clients"
            subtitle2 = "Rétention"
            subtitle3 = "Développement produits"
            subtitle4 = "Expansion marché"
            title = "Stratégie de croissance entreprise"
...
def main():
    ...
    test_runner = TestSlide33BlueDetailed()
