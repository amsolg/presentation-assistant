...
Test d'ajout de slide 29 (3 boîtes bleues avec sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 3 boîtes bleues
avec sous-titres dans une présentation existante en utilisant le template slide 29.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 29)
...
class TestSlide29BlueDetailed:
    """
    Classe de test pour vérifier l'ajout de slide 29 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 29"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_29"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 3 boîtes bleues avec sous-titres
            concept1 = "Notre feuille de route 2024 définit une approche progressive vers la digitalisation complète des processus métiers avec des objectifs mesurables."
            concept2 = "Le change management accompagne nos équipes dans l'adoption des nouvelles technologies grâce à une formation personnalisée et un support continu."
            concept3 = "Les partenariats R&D avec des leaders technologiques nous permettent d'innover rapidement et d'intégrer les dernières avancées dans nos solutions."
            subtitle1 = "Stratégie digitale"
            subtitle2 = "Transformation organisationnelle"
            subtitle3 = "Innovation technologique"
            title = "Piliers de la transformation numérique"
...
def main():
    ...
    test_runner = TestSlide29BlueDetailed()
