...
Test d'ajout de slide 30 (3 boîtes bleues sans sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 3 boîtes bleues
sans sous-titres dans une présentation existante en utilisant le template slide 30.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 30)
...
class TestSlide30BlueSimple:
    """
    Classe de test pour vérifier l'ajout de slide 30 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 30"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_30"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 3 boîtes bleues sans sous-titres
            title = "Nos valeurs fondamentales guidant la transformation digitale de l'entreprise"
            concept1 = "Efficacité opérationnelle maximisée grâce à l'automatisation intelligente des processus métier et l'optimisation continue des workflows organisationnels."
            concept2 = "Qualité exceptionnelle garantie par des standards rigoureux, des contrôles qualité approfondis et une démarche d'amélioration continue systématique."
            concept3 = "Innovation technologique constante avec adoption des dernières tendances, recherche proactive de solutions disruptives et culture d'expérimentation avancée."
...
def main():
    ...
    test_runner = TestSlide30BlueSimple()
