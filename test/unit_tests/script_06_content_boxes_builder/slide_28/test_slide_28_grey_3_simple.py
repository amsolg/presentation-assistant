...
Test d'ajout de slide 28 (3 boîtes grises sans sous-titres Premier Tech)

Ce test vérifie la capacité du script 06 à ajouter une slide avec 3 boîtes grises
sans sous-titres dans une présentation existante en utilisant le template slide 28.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide content boxes avec le script 06 (slide 28)
...
class TestSlide28GreySimple:
    """
    Classe de test pour vérifier l'ajout de slide 28 avec le script 06.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 06 - Slide 28"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_project = "test_script_06_slide_28"
    ...
    def add_content_boxes_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour 3 boîtes grises sans sous-titres
            title = "Solutions technologiques innovantes pour l'entreprise moderne"
            concept1 = "Interface utilisateur intuitive permettant une expérience optimale pour tous les utilisateurs de l'application métier."
            concept2 = "Traitement automatique des données en temps réel avec intelligence artificielle intégrée pour maximiser l'efficacité opérationnelle."
            concept3 = "Intégration API complète avec les systèmes existants garantissant une interopérabilité parfaite et une migration transparente."
...
def main():
    ...
    test_runner = TestSlide28GreySimple()
