...
# -*- coding: utf-8 -*-
"""
Script de lancement des tests pour navigation_builder
...
def main():
    """Fonction principale"""
    print(f"=== TESTS UNITAIRES - NAVIGATION_BUILDER ===")
    ...
    try:
        ...
        report_path = output_dir / f"test_navigation_builder_{timestamp}_report.json"
