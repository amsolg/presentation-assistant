...
# -*- coding: utf-8 -*-
"""
Script principal pour exécuter tous les tests du Simple Message Builder
...
def main():
    """Exécute tous les tests de simple message builder"""
    print("="*80)
    print("SIMPLE MESSAGE BUILDER - TESTS UNITAIRES COMPLETS")
    ...
    test_files = [
        "test_simple_message_builder.py",
        "centered_simple/presentation_schema.json",
        "centered_simple/simple_message_payload.json",
        "illustrated_message/presentation_schema.json",
        "illustrated_message/simple_message_payload.json",
        "keyword_emphasis/presentation_schema.json",
        "keyword_emphasis/simple_message_payload.json"
    ]
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "test_simple_message_builder.py"],
...
if __name__ == "__main__":
    print("Simple Message Builder - Tests Unitaires")
