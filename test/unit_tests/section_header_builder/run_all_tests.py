...
# -*- coding: utf-8 -*-
"""
Script principal pour exécuter tous les tests du Section Header Builder
...
def main():
    """Exécute tous les tests de section header builder"""
    print("="*80)
    print("SECTION HEADER BUILDER - TESTS UNITAIRES COMPLETS")
    ...
    test_files = [
        "test_section_header_builder.py",
        "major_section/presentation_schema.json",
        "major_section/section_header_payload.json",
        "moderate_section/presentation_schema.json",
        "moderate_section/section_header_payload.json",
        "custom_section/presentation_schema.json",
        "custom_section/section_header_payload.json"
    ]
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "test_section_header_builder.py"],
...
if __name__ == "__main__":
    print("Section Header Builder - Tests Unitaires")
