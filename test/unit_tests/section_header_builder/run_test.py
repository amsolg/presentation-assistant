...
# -*- coding: utf-8 -*-
"""
Script de lancement des tests pour section_header_builder
...
def main():
    """Fonction principale"""
    print(f"=== TESTS UNITAIRES - SECTION_HEADER_BUILDER ===")
    ...
    try:
        ...
        report_path = output_dir / f"test_section_header_builder_{timestamp}_report.json"

        report_data = {
            "timestamp": datetime.now().isoformat(),
            "module": "section_header_builder",
