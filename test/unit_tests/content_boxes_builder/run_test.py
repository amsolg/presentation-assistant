...
# -*- coding: utf-8 -*-
"""
Script de lancement des tests pour content_boxes_builder
...
def main():
    """Fonction principale"""
    print(f"=== TESTS UNITAIRES - CONTENT_BOXES_BUILDER ===")
    ...
    try:
        ...
        report_path = output_dir / f"test_content_boxes_builder_{timestamp}_report.json"

        report_data = {
            "timestamp": datetime.now().isoformat(),
            "module": "content_boxes_builder",
