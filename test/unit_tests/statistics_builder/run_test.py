...
# -*- coding: utf-8 -*-
"""
Script de lancement des tests pour statistics_builder
...
def main():
    """Fonction principale"""
    print(f"=== TESTS UNITAIRES - STATISTICS_BUILDER ===")
    ...
    try:
        ...
        report_path = output_dir / f"test_statistics_builder_{timestamp}_report.json"

        report_data = {
            "timestamp": datetime.now().isoformat(),
            "module": "statistics_builder",
