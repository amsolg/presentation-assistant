...
Test d'ajout de slide 40 (2 énoncés avec titre et ligne bleue Premier Tech)

Ce test vérifie la capacité du script 07 à ajouter une slide avec 2 énoncés titrés
avec ligne bleue dans une présentation existante en utilisant le template slide 40.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide explication détaillée avec le script 07 (slide 40)
...
class TestSlide40DualDetailedGrey:
    """
    Classe de test pour vérifier l'ajout de slide 40 avec le script 07.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 07 - Slide 40 (dual_detailed_grey)"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_subtitle = "Presentation de base pour test comparaison titree"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Dual Titled Blue"
            base_project = "test_script_07_slide_40"
    ...
    def add_explanation_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour comparaison détaillée avec ligne grise
            content = "Solutions On-Premise offrent un contrôle total et une sécurité maximale des données sensibles"
            title = "Comparaison Infrastructure Cloud vs On-Premise"
            subtitle = "Analyse comparative des approches technologiques"
            additional_content = "Solutions Cloud garantissent flexibilité, scalabilité automatique et réduction des coûts opérationnels"
            ...
            print(f"   CONTENU Additionnel: {additional_content}")
            print(f"   STYLE: dual_detailed_grey (slide 40)")
...
def main():
    ...
    test_runner = TestSlide40DualDetailedGrey()
