...
Test d'ajout de slide 41 (2 énoncés avec titre et ligne grise Premier Tech)

Ce test vérifie la capacité du script 07 à ajouter une slide avec 2 énoncés titrés
avec ligne grise dans une présentation existante en utilisant le template slide 41.

Workflow du test:
1. Créer une présentation de base avec le script 01
2. Ajouter une slide explication détaillée avec le script 07 (slide 41)
...
class TestSlide41DualTitledGrey:
    """
    Classe de test pour vérifier l'ajout de slide 41 avec le script 07.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 07 - Slide 41"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_subtitle = "Presentation de base pour test comparaison titree grise"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Dual Titled Grey"
            base_project = "test_script_07_slide_41"
    ...
    def add_explanation_slide(self, base_presentation_path):
        ...
        try:
            ...
            # Paramètres du test pour comparaison titrée avec ligne bleue
            content = "Approche Waterfall garantit une planification complète et une documentation exhaustive du projet"
            title = "Méthodologies de Gestion de Projet"
            additional_content = "Approche Agile favorise l'adaptabilité, la collaboration et la livraison continue de valeur"
            ...
            print(f"   STYLE: dual_titled_blue (slide 41)")
...
def main():
    ...
    test_runner = TestSlide41DualTitledGrey()
