...
Test d'ajout de slide 16 (section header moderate Premier Tech)

Ce test verifie la capacite du script 03 a ajouter une slide de section
moderee dans une presentation existante en utilisant le template slide 16.

Workflow du test:
1. Creer une presentation de base avec le script 01
2. Ajouter une section header moderee avec le script 03
...
class TestSlide16Moderate:
    """
    Classe de test pour verifier l'ajout de slide 16 avec le script 03.
    """

    def __init__(self):
        self.test_name = "Test Unitaire - Script 03 - Slide 16"
    ...
    def create_base_presentation(self):
        ...
        try:
            ...
            base_subtitle = "Presentation de base pour test section header moderee"
            base_metadata = f"{datetime.now().strftime('%Y.%m.%d')} - Test Section Header Moderate"
            base_project = "test_script_03_slide_16"
    ...
    def add_section_header_slide(self, base_presentation_path):
        """
        Ajoute une slide de section header moderee avec le script 03.
        ...
        """
        try:
            print(f"SECTION Etape 2: Ajout de la section header moderee...")

            # Parametres pour la section header
            section_title = "Section Moderee Sous-Detail"
            ...
            print(f"   INFO Style: moderate (slide 16)")
    ...
    def run_all_tests(self):
        """
        Execute tous les tests pour le script 03 slide 16.
...
def main():
    ...
    test_runner = TestSlide16Moderate()
