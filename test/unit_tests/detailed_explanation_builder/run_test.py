...
# -*- coding: utf-8 -*-
"""
Script de lancement des tests pour detailed_explanation_builder
...
def main():
    """Fonction principale"""
    print(f"=== TESTS UNITAIRES - DETAILED_EXPLANATION_BUILDER ===")
    ...
    try:
        ...
        report_path = output_dir / f"test_detailed_explanation_builder_{timestamp}_report.json"

        report_data = {
            "timestamp": datetime.now().isoformat(),
            "module": "detailed_explanation_builder",
